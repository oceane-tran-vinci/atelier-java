...
public class GestionPoulaillers {
  ...
  public static void main(String[] args) {
    ...
    Lot lotPoulesRousses = new LotImpl(NBR_POULES_ROUSSES, 90000, "Poules rousses");
    ...
    Poulailler poulaillerEnsoleille = new PoulaillerImpl("Poulailler ensoleillé", 10000);
    ...
    Lot lotPoulesBlanches = new LotImpl(NBR_POULES_BLANCHES, 30000, "Poules blanches");
    ...
    Poulailler poulaillerOmbrage = new PoulaillerImpl("Poulailler ombragé", 1000);
    ...
    Lot lotPoulesRoses = new LotImpl(NBR_POULES_ROSES, 5000, "Poules roses");
    ...
    Poulailler poulaillerLuxueux = new PoulaillerImpl("Poulailler luxueux", 1000);
